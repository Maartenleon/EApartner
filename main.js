...
(function () {
  ...
  const translations = {
    en: {
      ...
      'value-text1':         'The pattern is familiar. Too many initiatives, too little focus. An IT landscape that tangles as the organisation grows. Strategic direction that doesn\'t reach delivery. Delivery that drifts without strategic direction. Reasonable decisions, made locally, that turn out to be globally incoherent.',
      'value-text2':         'The need isn\'t more technology, more talent, or more effort. It\'s <strong>coherence</strong> — decisions that add up across the organisation rather than cancelling each other out. That\'s the work of enterprise architecture.',
      'value-text3':         'Architecture earns its place close enough to strategy to shape decisions, and close enough to delivery to govern what actually gets built. Its job is to keep the dependencies between strategy, capabilities, data, applications, and technology visible enough that the organisation can change deliberately, rather than discover its constraints too late. That\'s a discipline, not a document.',
      'value-text4':         'It shows up in two ways. When you\'re going through change, <strong>transformations need architecture to steer them</strong> — a spine that holds strategy and delivery together as the organisation moves. When you\'re building for the long term, <strong>the architecture function itself needs to deliver decisions, not artefacts</strong>. Where you start depends on where you are.',
      'services-eyebrow':    'What I offer',
      'services-h2':         'Services',
      'services-sub':        'Two tracks. One for organisations with complex transformations. One for organisations who want to improve their architecture function.',
    ...
    nl: {
      ...
      'value-text1':         'Het patroon is bekend. Te veel initiatieven, te weinig focus. Een IT-landschap dat verstrikt raakt naarmate de organisatie groeit. Strategische richting die de uitvoering niet bereikt. Uitvoering die afdrijft zonder strategische richting. Redelijke beslissingen, lokaal genomen, die mondiaal gezien incoherent blijken.',
      'value-text2':         'De behoefte is niet meer technologie, meer talent of meer inspanning. Het is <strong>samenhang</strong> — beslissingen die optellen in de hele organisatie in plaats van elkaar opheffen. Dat is het werk van enterprise architectuur.',
      'value-text3':         'Architectuur verdient haar plek dicht genoeg bij de strategie om beslissingen te vormen, en dicht genoeg bij de uitvoering om te sturen wat er daadwerkelijk wordt gebouwd. Haar taak is de afhankelijkheden tussen strategie, capabilities, data, applicaties en technologie zichtbaar genoeg te houden zodat de organisatie bewust kan veranderen, in plaats van haar beperkingen te laat te ontdekken. Dat is een discipline, niet een document.',
      'value-text4':         'Het manifesteert zich op twee manieren. Wanneer u een verandering doorgaat, <strong>hebben transformaties architectuur nodig om ze te sturen</strong> — een ruggengraat die strategie en uitvoering bij elkaar houdt terwijl de organisatie beweegt. Wanneer u bouwt voor de lange termijn, <strong>moet de architectuurfunctie zelf beslissingen leveren, niet artefacten</strong>. Waar u begint hangt af van waar u staat.',
      'services-eyebrow':    'Wat ik aanbied',
      'services-h2':         'Diensten',
      'services-sub':        'Twee tracks. Eén voor organisaties met complexe transformaties. Eén voor organisaties die hun architectuurfunctie willen verbeteren.',
