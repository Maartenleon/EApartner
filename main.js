...
(function () {
  ...
  const translations = {
    en: {
      ...
      'nav-about':           'About',
      'nav-contact':         'Contact',
      'hero-h1':             'The enterprise of tomorrow<br>is intelligent, agentic,<br>and built to change.',
      ...
      'value-h2':            'Every satisfying organisational experience (a product that works, a platform that scales, a decision that sticks) is held together by architecture most people never see.',
      ...
      'contact-h2':          'Complex landscape.<br>Decisions that move.<br>Architecture that lasts.',
      'contact-sub':         'One sharp conversation is often enough to cut through months of uncertainty. No preparation needed.',
    ...
    nl: {
      ...
      'nav-about':           'Over',
      'nav-contact':         'Contact',
      'hero-h1':             'De onderneming van morgen<br>is intelligent, agentisch,<br>en gebouwd om te veranderen.',
      ...
      'value-h2':            'Elke bevredigende organisatorische ervaring (een product dat werkt, een platform dat schaalt, een beslissing die beklijft) wordt bijeengehouden door architectuur die de meeste mensen nooit zien.',
      ...
      'about-role':          'Enterprise Architect',
      'about-bio':           'De meeste architectuurwerkzaamheden produceren documenten die informeren, maar niet beslissen. Ik werk andersom: artefacten moeten nuttig zijn op het moment dat een beslissing genomen moet worden. Heldere output. Snelle cycli. Geen model om het model. Houdt het minimaal, houdt het tempo hoog, en blijf dicht genoeg bij business, product, data en engineering om ze te verbinden wanneer het ertoe doet, totdat de weg vooruit vanzelfsprekend is.',
      ...
      'contact-h2':          'Complex landschap.<br>Beslissingen die bewegen.<br>Architectuur die beklijft.',
      'contact-sub':         'Eén scherp gesprek is vaak genoeg om maanden onzekerheid te doorbreken. Geen voorbereiding nodig.',
